        ...
        <div class="row g-2">
                ...
                <input type="text" 
                       ...
                       maxlength="4">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" v-model="form.asunto" class="form-control"
                                placeholder="How can we help you?" required>
                        </div>
                        <div class="col-12">
                            <label for="mensaje" class="form-label">Message *</label>
                            <textarea v-model="form.mensaje" class="form-control" rows="4"
                                placeholder="Tell us more about what you're looking for..." required></textarea>
                        </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="showroom-box p-4 rounded text-white">
                    ...
                    <p class="small mb-3">We invite you to visit our facilities where you can see our selection of
                        premium vehicles up close and receive personalized advice.</p>
                    <p class="small mb-0 fst-italic text-white-50">No appointment necessary! However, if you prefer, you
                        can reserve a specific time for exclusive attention.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-4">
                    <div class="contact-card shadow-lg">
                        ...
                        <p class="card-text">
                            <a href="mailto:info@automotoelite.com"
                                class="text-decoration-none text-muted">info@automotoelite.com</a>
                        </p>
                    </div>
                </div>
            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-6 offset-lg-1">
                    <div class="vip-card p-4 rounded text-center border-orange">
                        ...
                        <p class="text-muted small">We offer personalized advice outside regular business hours for
                            exclusive clients. Contact us via WhatsApp to schedule a private appointment.</p>
                        <a href="https://wa.me/34654916176?text=Hola,%20me%20gustaría%20solicitar%20una%20cita%20VIP"
                            target="_blank" class="btn btn-outline-light btn-sm mt-2">Request VIP Appointment</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-4 col-lg-3">
                    <div class="team-card text-center p-4 rounded shadow-lg">
                        ...
                        <div class="d-flex justify-content-center gap-2">
                            ...
                            <a href="mailto:javier@premiumcars.com" class="btn btn-team-social"><i
                ...
                <div class="col-md-4 col-lg-3">
                    <div class="team-card text-center p-4 rounded shadow-lg border-orange-thin">
                        ...
                        <div class="d-flex justify-content-center gap-2">
                            <a href="#" class="btn btn-team-social"><i class="bi bi-linkedin"></i></a>
                            <a href="mailto:elena@premiumcars.com" class="btn btn-team-social"><i
                                    class="bi bi-envelope"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-lg-3">
                    <div class="team-card text-center p-4 rounded shadow-lg">
                        ...
                        <div class="d-flex justify-content-center gap-2">
                            <a href="#" class="btn btn-team-social"><i class="bi bi-linkedin"></i></a>
                            <a href="mailto:marcos@premiumcars.com" class="btn btn-team-social"><i
                                    class="bi bi-envelope"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="accordion custom-accordion" id="accordionFAQ">
                        ...
                        <div class="accordion-item mb-3 border-0 shadow-sm rounded">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFAQ">
                                <div class="accordion-body text-muted">
                                    We offer an exclusive selection of sports and high-end vehicles, including brands
                                    such as BMW, Audi, Porsche and Ducati.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item mb-3 border-0 shadow-sm rounded">
                            ...
                            <div id="collapseFive" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body text-muted">
                                    All our vehicles include a premium warranty of 12 to 24 months depending on model
                                    and year.
                                </div>
                            </div>
                        </div>
